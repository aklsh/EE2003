 ...
 * Last Modified: 07:43:16 06 Nov 2020
 * Description:
 *
 */
...
#define OUTPERIPH_BASE 0x00004000
#define OUTPERIPH_WRITE_OFFSET 0x0000000
#define OUTPERIPH_READSTATUS_OFFSET 0x00000004

void _outbyte(int c)
{
	// Fill in the code here
        // What you need is to write to the address of the peripheral (as defined in the BIU)
        // Example code here:
...
int readstatus()
{
        ...
        int *p;
        p = (OUTPERIPH_BASE + OUTPERIPH_READSTATUS_OFFSET);
        return (*p);
}
